...
Ud. debe crear el archivo disk.c y reprogramar ahí las funciones solicitadas.
Ya hay una plantilla para disk.c en disk.c.plantilla.
...
archivo disk.zip que contiene disk.c, con su solución, y resultados.txt,
